    ...
    <div className="container px-6 py-10 mx-auto">
        <div className="xl:flex xl:items-center xL:-mx-4">
            ...
            <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-0 xl:mx-4 xl:w-1/2 md:grid-cols-3">
                <div>
                    <Image className="object-cover rounded-xl aspect-square" width={200} height={200} src="/pexels-katerina-holmes-5905753.jpg" alt=""/>
                ...
                <div>
                    <Image className="object-cover rounded-xl aspect-square" width={200} height={200} src="https://images.unsplash.com/photo-1499470932971-a90681ce8530?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt=""/>
